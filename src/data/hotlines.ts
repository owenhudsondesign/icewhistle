...
export const HOTLINES: Hotline[] = [
  ...
  },
  {
    ...
    // The phone line and the online locator are two different ICE services.
    // This entry is the phone line; its hours are ICE's own published hours,
    // which are not 24/7. The website field points at the locator, which can
    // be searched at any time.
    name: 'ICE Detention Information Line (DRIL)',
    nameEs: 'Línea de Información sobre Detención de ICE (DRIL)',
    phone: '1-888-351-4024',
    description: 'Ask ICE about someone in custody. Search locator.ice.gov anytime.',
    descriptionEs: 'Pregunta a ICE sobre alguien detenido. Busca en locator.ice.gov a cualquier hora.',
    languages: ['en', 'es'],
  ...
  // === MARYLAND / VIRGINIA / PENNSYLVANIA (multi-state) ===
  {
    id: 'casa-mdvapa',
    name: 'CASA Raid Report Hotline',
    nameEs: 'Línea de Reporte de Redadas de CASA',
    phone: '1-888-214-6016',
    description: 'Report ICE activity and get referrals - Maryland, Virginia and Pennsylvania',
    descriptionEs: 'Reporta actividad de ICE y obtén referencias - Maryland, Virginia y Pensilvania',
    languages: ['en', 'es', 'fr'],
    hours: '24/7',
    website: 'https://wearecasa.org',
    coverage: ['MD', 'VA', 'PA', '206', '207', '208', '209', '210', '211', '212', '213', '214', '215', '216', '217', '218', '219', '220', '221', '222', '223', '224', '225', '226', '227', '228', '229', '230', '231', '232', '233', '234', '235', '236', '237', '238', '239', '240', '241', '242', '243', '244', '245', '246', '150', '151', '152', '153', '154', '155', '156', '157', '158', '159', '160', '161', '162', '163', '164', '165', '166', '167', '168', '169', '170', '171', '172', '173', '174', '175', '176', '177', '178', '179', '180', '181', '182', '183', '184', '185', '186', '187', '188', '189', '190', '191', '192', '193', '194', '195', '196'],
    priority: 1,
    type: 'state',
  },
  ...
  {
    id: 'pa-nsm-philly',
    name: 'New Sanctuary Movement (Philadelphia)',
    nameEs: 'New Sanctuary Movement (Filadelfia)',
    phone: '1-267-217-2292',
    description: 'Philadelphia rapid response - report ICE activity',
    descriptionEs: 'Respuesta rápida de Filadelfia - reportar actividad de ICE',
    languages: ['en', 'es'],
    hours: 'Call for availability',
    website: 'https://www.paimmigrant.org/rapid-response-information',
    coverage: ['190', '191'],
    priority: 2,
    type: 'local',
  },
  {
    id: 'pa-allegheny',
    name: 'Allegheny County Rapid Response (Pittsburgh)',
    nameEs: 'Respuesta Rápida del Condado de Allegheny (Pittsburgh)',
    phone: '1-412-536-6423',
    description: 'Pittsburgh area rapid response - report ICE activity',
    descriptionEs: 'Respuesta rápida del área de Pittsburgh - reportar actividad de ICE',
    languages: ['en', 'es'],
    hours: 'Call for availability',
    website: 'https://www.paimmigrant.org/rapid-response-information',
    coverage: ['150', '151', '152', '153'],
    priority: 2,
    type: 'local',
  },
  {
    id: 'pa-pirc',
    name: 'PIRC (Adams, Franklin, Lancaster, York)',
    nameEs: 'PIRC (Adams, Franklin, Lancaster, York)',
    phone: '1-717-229-7452',
    description: 'South central Pennsylvania rapid response and legal support',
    descriptionEs: 'Respuesta rápida y apoyo legal del centro sur de Pensilvania',
    languages: ['en', 'es'],
    hours: 'Call for availability',
    website: 'https://www.paimmigrant.org/rapid-response-information',
    coverage: ['170', '171', '172', '173', '174', '175', '176'],
    priority: 2,
    type: 'local',
  },
  ...
  // === MINNESOTA ===
  {
    id: 'mn-immigrant-defense',
    name: 'Immigrant Defense Network',
    nameEs: 'Red de Defensa del Inmigrante',
    phone: '1-612-255-3112',
    description: 'Minnesota rapid response - report ICE activity you witness',
    descriptionEs: 'Respuesta rápida de Minnesota - reporta actividad de ICE que presencies',
    languages: ['en', 'es'],
    hours: 'Call for availability',
    website: 'https://www.ilcm.org/ice-detention-raids',
    coverage: ['MN', '550', '551', '552', '553', '554', '555', '556', '557', '558', '559', '560', '561', '562', '563', '564', '565', '566', '567'],
    priority: 1,
    type: 'state',
  },
  {
    id: 'mn-ilcm-detention',
    name: 'ILCM Detention Line (Minnesota)',
    nameEs: 'Línea de Detención de ILCM (Minnesota)',
    phone: '1-651-641-1011',
    description: 'Call if someone has been detained by ICE in Minnesota',
    descriptionEs: 'Llama si ICE ha detenido a alguien en Minnesota',
    languages: ['en', 'es'],
    hours: 'Mon-Thu 1pm-3pm CT',
    website: 'https://www.ilcm.org/ice-detention-raids',
    coverage: ['MN', '550', '551', '552', '553', '554', '555', '556', '557', '558', '559', '560', '561', '562', '563', '564', '565', '566', '567'],
    priority: 2,
    type: 'state',
  },
  {
    id: 'mn-cair',
    name: 'CAIR Minnesota',
    nameEs: 'CAIR Minnesota',
    phone: '1-612-206-3360',
    description: 'Immigration legal services and referrals in Minnesota',
    descriptionEs: 'Servicios legales de inmigración y referencias en Minnesota',
    languages: ['en', 'es'],
    hours: 'Call for availability',
    website: 'https://www.ilcm.org/ice-detention-raids',
    coverage: ['MN', '550', '551', '552', '553', '554', '555', '556', '557', '558', '559', '560', '561', '562', '563', '564', '565', '566', '567'],
