...
const emergencyTranslations = {
  en: {
    ...
    anonymous100m: 'Anonymous • Location rounded to ~100m for privacy',
  ...
  es: {
    ...
    anonymous100m: 'Anónimo • Ubicación redondeada a ~100m para privacidad',
  ...
  pt: {
    ...
    anonymous100m: 'Anônimo • Localização arredondada para ~100m para privacidade',
