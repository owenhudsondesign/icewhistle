...
const translations = {
  en: {
    ...
    saving: 'Saving...',
    privacyNote: 'ZIP stored on device for map. If push enabled, also stored on server (can be deleted in settings).',
  ...
  es: {
    ...
    saving: 'Guardando...',
    privacyNote: 'Código guardado en dispositivo. Si push está habilitado, también en servidor (borrable en ajustes).',
  ...
  pt: {
    ...
    saving: 'Salvando...',
    privacyNote: 'CEP salvo no dispositivo. Se push ativado, também no servidor (pode ser apagado nas config.).',
